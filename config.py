...
OWNER_USERNAME = os.getenv("OWNER_USERNAME", "stakes_xd")
BOT_USERNAME = os.getenv("BOT_USERNAME", "sayoni_music_bot")
...
UPSTREAM_REPO = os.getenv("UPSTREAM_REPO", "https://github.com/Ankit0085d/ShrutiMusic")
UPSTREAM_BRANCH = os.getenv("UPSTREAM_BRANCH", "main")
GIT_TOKEN = os.getenv("GIT_TOKEN", None)

SUPPORT_CHANNEL = os.getenv("SUPPORT_CHANNEL", "https://t.me/SAYONI_UPDATES")
SUPPORT_GROUP = os.getenv("SUPPORT_GROUP", "https://t.me/HELLFIRE_DOMINION")
INSTAGRAM = os.getenv("INSTAGRAM", "https://instagram.com/_just_failuer")
YOUTUBE = os.getenv("YOUTUBE", "https://www.youtube.com/@itsMeChampu")
GITHUB = os.getenv("GITHUB", "https://github.com/Ankit0085d")
DONATE = os.getenv("DONATE", "https://t.me/Stakes_pay/6")
...
START_IMG_URL = os.getenv("START_IMG_URL", "https://files.catbox.moe/ky0q4x.jpg")
PING_IMG_URL = "https://files.catbox.moe/8shy67.jpg"
